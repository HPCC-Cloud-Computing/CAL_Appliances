...
PERIODIC_CHECK_STATUS_TIME = 180
PERIODIC_SEND_STATUS_TIME =120
PERIODIC_UPDATE_AND_POPULATE_RING = 120

MESSAGE_QUEUE_IP = '172.20.5.1'
ZOOKEEPER_IP = '172.20.7.1'
ZOOKEEPER_PORT = '2181'
MEMCACHED_IP = '172.20.6.1'
MEMCACHED_PORT = 11211
shared_db_connection_url = \
    'mysql+pymysql://root:bkcloud@172.20.3.1:3306/shared_db'
